...
## Beskrivning
Konsol-app med meny som kan hantera böcker, medlemmar och utlåning av böcker till medlemmar.
Menu.java är ansvarig för kontakt med användaren, Library.java för logiken.
Appen består av 3 arrayer med fast storlek [10].
Böcker representeras av record Book.
Medlemmar av klassen Member.
Utlåning av record Loan, som håller en bok och den medlem som lånat den.
